...
function show_chat_bot(){
  document.getElementsByClassName("chatbot")[0].style.display = "block"
  document.getElementsByClassName("chatbot1")[0].style.display = "none"
}
function hide_chat_box(){
  document.getElementsByClassName("chatbot")[0].style.display = "none"
  document.getElementsByClassName("chatbot1")[0].style.display = "block"
